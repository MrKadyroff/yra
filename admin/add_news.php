        ...
        <div class="col-md-12 col-md-offset-3">
          ...
          <form id="upload-image" enctype="multipart/form-data">
            <div class="form-group">
              <label for="image">News header:</label>
              <input class="form-control" type="text" name="news_header" required>
            </div>
           
            <div class="form-group">
              <label for="image">News anons:</label>
              <input class="form-control" type="text" name="news_anons" required>
            </div>
             <div class="form-group">
              <label for="image">News info:</label>
              <input class="form-control" type="text" name="news_info" required>
            </div>
           ...
           <label for="inputDate">Введите дату:</label>
            ...
            <div class="form-group">
              <label for="image" style="border: solid 1px black !important; padding: 5px;">News Image</label>
...
<script>
  ...
  $('#upload-image').on('submit',(function(e) {
    ...
    $.ajax({
      ...
      url: '../endpoints/new_news.php', // Скрипт обработчика
