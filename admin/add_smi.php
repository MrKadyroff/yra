        ...
        <div class="col-md-12 col-md-offset-3">
          ...
          <form id="upload-image" enctype="multipart/form-data">
            <div class="form-group">
              <label for="image">smi header:</label>
              <input class="form-control" type="text" name="smi_header" required>
            </div>
           
            
             <div class="form-group">
              <label for="image">smi info:</label>
              <input class="form-control" type="text" name="smi_info" required>
            </div>

            <div class="form-group">
           <label for="inputDate">Выберите дату:</label>
            <input type="date" name="smi_date" class="form-control">
           </div>
            
           
            <div class="form-group">
              <label for="image" style="border: solid 1px black !important; padding: 5px;">SMI Image</label>
...
<script>
  ...
  $('#upload-image').on('submit',(function(e) {
    ...
    $.ajax({
      ...
      url: '../endpoints/new_smi.php', // Скрипт обработчика
