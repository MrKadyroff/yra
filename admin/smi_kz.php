      ...
      <nav class="navbar navbar-expand-lg navbar-transparent  bg-primary  navbar-absolute">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="#pablo">Dashboard / SMI → KZ</a>
            <a href="smi_en.php"><button class="btn btn-info">EN</button></a>
            <a href="smi_ru.php"><button class="btn btn-success">RU</button></a>
          </div>
      ...
      <div class="content">
        <div class="row">
          ...
          <?php 
              ...
              $selProd = "SELECT * FROM smi WHERE lang = 'kz'";
            ...
            <div class="card card-chart"  >
              ...
              <img src="../'.$row['smi_photo'].'" style="height:30vh ; width20vw;">
               <p>smi Header: '.$row['smi_header'].'</p>
               <p>All info: '.$row['smi_info'].'</p>
               <p>Date: '.$row['smi_date'].'</p>
               
            

               <form id="del'.$row['smi_id'].'">
               <input type="text" name="smi_id" value="'.$row['smi_id'].'" style="display:none;">
