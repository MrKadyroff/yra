      ...
      <nav class="navbar navbar-expand-lg navbar-transparent  bg-primary  navbar-absolute">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="#pablo">Dashboard / SMI → RU</a>
            <a href="smi_kz.php"><button class="btn btn-info">KZ</button></a>
            <a href="smi_en.php"><button class="btn btn-success">EN</button></a>
          </div>
      ...
      <div class="content">
        <div class="row">
          ...
          <?php 
              ...
              $selProd = "SELECT * FROM smi WHERE lang = 'ru'";
