...
<div class="wrap">
    <div class="mobile-nav">
        ...
        <ul class="mobile-menu">
            <li class="mobile-menu__item"><a class="mobile-menu__link page-scroll" href="#home">Главная</a></li>
            <li class="mobile-menu__item"><a class="mobile-menu__link page-scroll" href="#about">О нас</a></li>
                    ...
                    <li class="lang-switcher__menu">
                        ...
                        <ul class="lang-switcher__submenu">
                            <li class="lang-switcher__item active">
                                <a class="lang-switcher__link active" href="#">Русский</a>
                            </li>
                            <li class="lang-switcher__item">
                                <a class="lang-switcher__link" href="#">English</a>
                            </li>
                            <li class="lang-switcher__item">
                                <a class="lang-switcher__link" href="#">Қазақша</a>
                            </li>
                        </ul>
                    </li>
                </ul>
    ...
    <div class="screen screen-news">
        <div class="my-container">
            <div class="screen__body">
                <h2 id="news" class="screen-heading">Новости</h2>
                        ...
                        <div class="swiper-wrapper">
                            <div class="news-item swiper-slide">
                                <div class="news-image">
                                    <img class="news-image__default" src="./img/news-image.png" alt="img">
                                    <img class="news-image__full" src="./img/news-image-full.png" alt="img">
                                </div>
                                <div class="news-body">
                                    <div class="news-item-date">18.02.2021</div>
                                    <h1 class="news-item-heading">Lorem ipsum dolor sit amet, consectetur adipiscing
                                        elit 1</h1>
                                    <div class="news-item-content">
                                        <div class="news-item-content__default">
                                            <p>Mattis viverra non parturient libero fringilla eu, ut adipiscing arcu.
                                                Enim
                                                laoreet volutpat ipsum est quisque justo. Ac enim facilisis sem nulla.
                                                Blandit nisi egestas risus, amet, lectus turpis. Aliquet vitae congue
                                                donec
                                                congue semper. Justo, luctus dolor placerat quis sem dapibus egestas.
                                                Tristique nec consequat nibh blandit venenatis eu, risus, semper.
                                                Fermentum
                                                enim sagittis consectetur cursus id elementum. Tempus quis vitae mi
                                                elementum mauris hac. Augue nullam eget sodales pulvinar luctus egestas
                                                morbi integer. Nulla faucibus fusce sapien lectus tellus nibh.</p>
                                        </div>
            ...
            <div class="screen__body">
                ...
                <div class="projects-slider-wrap">
                    <div class="project-slider swiper-container">
                        <div class="swiper-wrapper">
                            <a href="#" class="project-item swiper-slide">
                                <img class="project-item__image" src="./img/project.png" alt="img">
                                <div class="project-item__description">
                                    Cursus platea viverra purus platea. Imperdiet sapien cursus arcu, ante diam enim
                                    amet. Aliquam, est nulla sed placerat ultricies augue ipsum augue a. Pretium massa
                                    hac sed tristique placerat.
                                </div>
                            </a><!-- .project-item -->
                            <a href="#" class="project-item swiper-slide">
                                <img class="project-item__image" src="./img/project.png" alt="img">
